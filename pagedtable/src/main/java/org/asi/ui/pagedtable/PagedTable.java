...
import org.asi.ui.container.PagedTableContainer;
 ...
 * @param <T>
 */
public class PagedTable<T extends Container.Indexed & Container.Filterable & Container.ItemSetChangeNotifier>
        extends Table {
    ...
    private PagedTableContainer<T> container;
    ...
    @Override
    public PagedTableContainer<T> getContainerDataSource() {
        return container;
    }
    ...
    public void setContainerDataSource(Container newDataSource) {
        ...
        PagedTableContainer<T> pagedTableContainer = new PagedTableContainer<T>(
                (T) newDataSource);
