 ...
 * @param <BEANTYPE>
 */
public class TreeContainer<BEANTYPE> extends BeanItemContainer<BEANTYPE> implements
        Hierarchical {
    ...
    public TreeContainer(Class<? super BEANTYPE> type)
    ...
    public TreeContainer(Collection<? extends BEANTYPE> collection)
            throws IllegalArgumentException {
        super(collection);
    }
    ...
    private static final Logger getLogger() {
        return Logger.getLogger(TreeContainer.class.getName());
    }
